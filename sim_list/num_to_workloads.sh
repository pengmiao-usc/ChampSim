...
do
    ...
    line1=`sed -n ''$num'p' test.txt | awk '{print $1}'`
    line2=`sed -n ''$num'p' test.txt | awk '{print $2}'`
    line3=`sed -n ''$num'p' test.txt | awk '{print $3}'`
    line4=`sed -n ''$num'p' test.txt | awk '{print $4}'`
